...
const PostDetail: React.FC = () => {
  ...
  const authorName =
    typeof postData?.author === 'string' ? postData.author : postData?.author?.username || '알 수 없음';
        ...
        <div className={styles.infoSection}>
          ...
          <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <button
              onClick={handleLike}
              style={{
                background: isLiked ? 'linear-gradient(135deg, #ff6b6b 0%, #ee5a6f 100%)' : 'white',
                ...
                gap: '0.5rem',
                transition: 'all 0.2s',
                boxShadow: isLiked ? '0 4px 6px -1px rgba(239, 68, 68, 0.3)' : '0 1px 3px 0 rgba(0, 0, 0, 0.1)',
              }}
              onMouseEnter={(e) => {
                if (!isLiked) {
